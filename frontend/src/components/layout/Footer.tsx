    ...
    <footer className="bg-slate-950 text-slate-300 pt-16 pb-8 border-t border-slate-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li><Link href="/trips" className="hover:text-rose-400 transition-colors">Upcoming Treks</Link></li>
              <li><Link href="/expeditions" className="hover:text-rose-400 transition-colors">Expeditions</Link></li>
              <li><Link href="/contact" className="hover:text-rose-400 transition-colors">Contact Us</Link></li>
              <li><Link href="/blog" className="hover:text-rose-400 transition-colors">Our Blog</Link></li>
            </ul>
          </div>

          {/* Policies */}
          <div>
            <h3 className="text-white font-heading font-semibold mb-6">Policies</h3>
            <ul className="space-y-3 text-sm">
              <li><Link href="/privacy" className="hover:text-rose-400 transition-colors">Privacy Policy</Link></li>
              <li><Link href="/terms" className="hover:text-rose-400 transition-colors">Terms & Conditions</Link></li>
              <li><Link href="/cancellation" className="hover:text-rose-400 transition-colors">Cancellation Policy</Link></li>
              <li><Link href="/environmental" className="hover:text-rose-400 transition-colors">Environmental Policy</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              <li className="flex items-start gap-3">
                ...
                <span>123 Adventure Lane, Mall Road, Manali, Himachal Pradesh 175131</span>
              </li>
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="mailto:info@summitseekers.com" className="hover:text-rose-400 transition-colors">info@summitseekers.com</a>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="pt-8 border-t border-slate-800 flex flex-col md:flex-row justify-between items-center gap-4 text-xs opacity-60">
          <p>© 2026 Summit Seekers. All rights reserved.</p>
          <div className="flex gap-4">
            <span>License: HP-TOUR-2026/894</span>
            <span>GSTIN: 05ABCFP5491P1ZN</span>
          </div>
        </div>
      </div>
    </footer>
